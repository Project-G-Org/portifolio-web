        ...
        >
          ...
          <article className="flex flex-col w-full gap-12">
            ...
            <p className="text-graylight text-2xl">
              Contrate uma equipe de especialistas oferecendo soluções completas
              de software <br /> para impulsionar seu negócio com agilidade e
              eficiência.
            </p>
          ...
          <article className="flex flex-row gap-36 text-start">
            <div className="flex flex-col gap-4">
              ...
              <span className="text-base">
                Email:{' '}
                <a href="mailto:vigelcontato@gmail.com">
                  vigelcontato@gmail.com
                </a>
              </span>
